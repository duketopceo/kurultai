...
|------|------|-------|---------|-------|-----|-----------|
| [`BrainView.ts`](BrainView.ts) | 3D synaptic canvas + layout tween + metrics() | `website/src/brain/../assets/brain.glb?url` · `website/src/brain/../types` · `website/src/brain/../state` · `website/src/brain/layout/createWorker` · `website/src/brain/layout/sdf` | — | 2026-09-06 | 2 | 2026-09-06 metrics() scene snapshot (edge-length stats, hull containment %, fps) · 2026-09-06 push SDF to in-flight worker (workerHasSdf + setSdf) · 2026-08-16 indexed (v1 seed) |
