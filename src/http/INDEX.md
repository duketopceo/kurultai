...
| [`mod.rs`](mod.rs) | Axum daemon: /api/*, /ui/, optional /mcp SSE | `src/brain` · `src/daemon` · `src/error` · `src/mcp` · `src/metrics` · `src/http/hub_listen.rs` | `src/daemon/mod.rs` | 2026-08-29 | 2 | 2026-08-29 resolve_listen_socket before bind · 2026-08-16 indexed (v1 seed) |
