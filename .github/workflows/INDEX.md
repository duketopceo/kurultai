...
|------|------|-------|---------|-------|-----|-----------|
| [`ci.yml`](ci.yml) | CI: fmt/clippy/nextest, Brain UI, macOS smoke, cargo-audit, postgres, agent-index | `.github/workflows/ci.yml` | `scripts/audit-agent-index.py` | 2026-09-11 | 3 | 2026-09-11 website unit tests step covers all src/**/*.test.ts · 2026-08-16 added Agent index job · 2026-08-16 indexed (v1 seed) |
