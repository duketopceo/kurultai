...
| [`evals_search.rs`](evals_search.rs) |  Eval harness: run_eval over served fixture app, matcher variants, stub-judge nDCG, judge circuit-breaker, ignored live Jev smoke  | `src/eval` · `src/http` | `tests/fixtures/evals/` | 2026-09-18 | 2 | 2026-09-18 judge circuit-breaker test (FailingJudge → 3 calls then disabled) · 2026-09-17 added |
