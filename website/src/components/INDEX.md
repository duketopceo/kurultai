...
| [`BrainStage.tsx`](BrainStage.tsx) | 3D stage host + `__kurultaiBrain` metrics handle + BrainHud chip + intentional-link selection | `website/src/components/../brain/BrainView` · `website/src/components/../brain/linkSelect` · `website/src/components/../types` | — | 2026-09-12 | 3 | 2026-09-12 buildLinks routes through selectIntentionalLinks (top-K nominations + low-degree survivors) · 2026-09-07 buildLinks strength = shared-tag count · 2026-09-06 BrainHud live FPS/neurons/synapses chip · 2026-09-06 expose `window.__kurultaiBrain` for `metrics()` · 2026-08-16 indexed (v1 seed) |
