...
|------|------|-------|---------|-------|-----|-----------|
| [`App.tsx`](App.tsx) | Brain dashboard shell (stats + stage + inspector + review queue) | `website/src/state` · `website/src/api` · `website/src/components/TopBar` · `website/src/components/BrainStage` · `website/src/components/CommandStrip` | — | 2026-09-11 | 3 | 2026-09-11 mount ProposalsPanel (#118) · 2026-09-05 fetchGraph limit by load tier · 2026-09-04 token prompt + logout wiring · 2026-08-16 indexed (v1 seed) |
...
| [`styles.css`](styles.css) | Dashboard CSS (black/white/purple) | — | — | 2026-09-11 | 3 | 2026-09-11 `.proposals-*` review queue styles (#118) · 2026-09-04 human login + access panel styles · 2026-08-16 indexed (v1 seed) |
