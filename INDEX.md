...
| [`.env.example`](.env.example) | Example env vars (API keys, hub bind) | — | — | 2026-08-12 | 1 | 2026-08-16 indexed (v1 seed) |
...
| [`CONCEPTS.md`](CONCEPTS.md) | Shared domain vocabulary (atoms, hub, FTS-first, ontology) | — | — | 2026-08-13 | 1 | 2026-08-16 indexed (v1 seed) |
...
| [`Cargo.toml`](Cargo.toml) | Rust crate manifest (v0.4.1) and optional features | — | — | 2026-08-13 | 1 | 2026-08-16 indexed (v1 seed) |
