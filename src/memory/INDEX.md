...
| [`tier.rs`](tier.rs) | Corpus / memory tier helpers | `src/types` | `src/store/mod.rs` · `src/store/postgres.rs` | 2026-09-15 | 2 | 2026-09-15 `TierRule` + `classify_atom` — declarative sequester caps (#325) |
